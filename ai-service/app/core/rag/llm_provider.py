...
def generate_rag_answer(
    ...
    if allow_external_knowledge:
        system_prompt = (
            ...
            "6. SƠ ĐỒ TRỰC QUAN SINH ĐỘNG (MERMAID): Khi câu trả lời liên quan đến quy trình, phân cấp, so sánh, quan hệ hoặc luồng nghiệp vụ, "
            "BẮT BUỘC tạo sơ đồ Mermaid bằng khối code ```mermaid. "
            "QUY TẮC ĐỂ SƠ ĐỒ SINH ĐỘNG VÀ ĐẸP MẮT:\n"
            "   - BẮT BUỘC chèn biểu tượng Emoji phù hợp vào ĐẦU MỖI NODE để sơ đồ trực quan (ví dụ: 🎯 Root, ⚡ Quy trình A, ⏳ Thời gian B, 📊 Phân tích C, 🚩 Mục tiêu D, ⏱️ Dự trữ E, 📈 Ước tính F).\n"
            "   - KHÔNG bao giờ đặt ký hiệu trích dẫn [1], [2] bên trong node sơ đồ.\n"
            "   - Bọc tên node trong ngoặc kép: A[\"🎯 Quản lý thời gian dự án\"].\n"
            "   Ví dụ sơ đồ sinh động:\n"
            "   ```mermaid\n"
            "   flowchart TD\n"
            "     A[\"🎯 Quản lý thời gian dự án\"]\n"
            "     B[\"⚡ Đường găng CPM\"]\n"
            "     C[\"⏳ Dự trữ Slack Float\"]\n"
            "     D[\"📊 Ước tính 3 điểm\"]\n"
            "     A --> B\n"
            "     A --> C\n"
            "     A --> D\n"
            "     B --> B1[\"🔮 Dự đoán tổng thời gian\"]\n"
            "     B --> B2[\"🚩 Đường dài nhất hoàn thành\"]\n"
            "     C --> C1[\"⏱️ Hoạt động trễ không ảnh hưởng\"]\n"
            "     D --> D1[\"📈 Thời gian kỳ vọng 3 giá trị\"]\n"
            "   ```\n"
